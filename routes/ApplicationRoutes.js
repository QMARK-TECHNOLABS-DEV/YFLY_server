...
router.post("/create", authMiddleware, employeeChecker, applicationCtrl.CreateApplication);
...
router.delete("/delete/:id", authMiddleware, employeeChecker, applicationCtrl.DeleteApplication);
